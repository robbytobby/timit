...
role :web, "sw2.physchem.uni-freiburg.de"                          # Your HTTP server, Apache/etc
role :app, "sw2.physchem.uni-freiburg.de"                          # This may be the same as your `Web` server
role :db,  "sw2.physchem.uni-freiburg.de", :primary => true # This is where Rails migrations will run
