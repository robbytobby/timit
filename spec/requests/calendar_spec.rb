  ...
  describe "GET /index" do
    ...
    it "renders bookings and new links correctly" do
      ...
      response.body.should have_selector(:table, :class => 'calendar') do |table|
        ...
        layout_check(table, :row => {:number => 2, :class => 'day6 even height-2', :date => "Sa, 10.12.2011"}, 
        ...
        layout_check(table, :row => {:number => 3, :class => 'day0 odd height-2', :date => "So, 11.12.2011"}, 
                     :machine1 => ['free'], 
                     :machine2 => ['free'], 
                     :machine3 => ['spacer', 'free'], 
                     :machine4 => [])
        layout_check(table, :row => {:number => 4, :class => 'day1 even height-5', :date => "Mo, 12.12.2011"}, 
                     ...
                     :machine4 => [])
        layout_check(table, :row => {:number => 5, :class => 'day2 odd height-1', :date => "Di, 13.12.2011"}, 
                     ...
                     :machine4 => [])
        layout_check(table, :row => {:number => 6, :class => 'day3 even height-8', :date => "Mi, 14.12.2011"}, 
        ...
        layout_check(table, :row => {:number => 7 , :class => 'day4 odd height-1', :date => "Do, 15.12.2011"}, 
                     :machine1 => [],
                     :machine2 => [],
                     :machine3 => [],
                     :machine4 => ['free'])
        layout_check(table, :row => {:number => 8, :class => 'day5 even height-4', :date => "Fr, 16.12.2011"}, 
                     ...
                     :machine4 => ['free'])
        layout_check(table, :row => {:number => 9, :class => 'day6 odd height-1', :date => "Sa, 17.12.2011"}, 
                     :machine1 => [],
        ...
        layout_check(table, :row => {:number => 10 , :class => 'day0 even height-2', :date => "So, 18.12.2011"}, 
                     :machine1 => [],
                     :machine2 => [{:class => 'all_day booking from_midnight height-2-1', :id => 'booking_102'}],
                     :machine3 => ['free'],
                     :machine4 => ['spacer', 'free'])
        layout_check(table, :row => {:number => 11 , :class => 'day1 odd height-1', :date => "Mo, 19.12.2011"}, 
                     :machine1 => [],
                     :machine2 => ['free'],
                     :machine3 => [{:class => 'all_day booking from_midnight height-11-4 multiday', :id => 'booking_115'}],
                     :machine4 => ['free'])
        layout_check(table, :row => {:number => 12 , :class => 'day2 even height-3', :date => "Di, 20.12.2011"}, 
                     :machine1 => [],
                     :machine2 => ['free'],
                     :machine3 => [],
                     :machine4 => ['free', {:class => 'booking height-1-0', :id => 'booking_124'}, {:class => 'booking height-10-2 multiday', :id => 'booking_134'}])
        layout_check(table, :row => {:number => 13 , :class => 'day3 odd height-2', :date => "Mi, 21.12.2011"}, 
                     :machine1 => [],
                     :machine2 => ['free', {:class => 'booking height-9-2 multiday', :id => 'booking_116'}],
                     :machine3 => [],
                     :machine4 => [])
        layout_check(table, :row => {:number => 14, :class => 'day4 even height-1', :date => "Do, 22.12.2011"}, 
                     :machine1 => [],
                     :machine2 => [],
                     :machine3 => [],
                     :machine4 => [])
        layout_check(table, :row => {:number => 15, :class => 'day5 odd height-2', :date => "Fr, 23.12.2011"}, 
                     :machine1 => ['spacer', 'free'],
                     :machine2 => [],
                     :machine3 => [],
                     :machine4 => [])
        layout_check(table, :row => {:number => 16, :class => 'day6 even height-1', :date => "Sa, 24.12.2011"}, 
                     :machine1 => [{:class => 'all_day booking from_midnight height-2-0 multiday', :id => 'booking_117'}],
                     :machine2 => [],
                     :machine3 => [],
                     :machine4 => [])
        layout_check(table, :row => {:number => 17, :class => 'day0 odd height-1', :date => "So, 25.12.2011"}, 
                     :machine1 => [],
                     :machine2 => [],
                     :machine3 => [],
                     :machine4 => [])
        layout_check(table, :row => {:number => 18, :class => 'day1 even height-1', :date => "Mo, 26.12.2011"}, 
                     :machine1 => ['free'],
                     :machine2 => [],
                     :machine3 => ['free'],
                     :machine4 => [])
        layout_check(table, :row => {:number => 19, :class => 'day2 odd height-2', :date => "Di, 27.12.2011"}, 
                     ...
                     :machine4 => ['spacer', 'free'])
        layout_check(table, :row => {:number => 20, :class => 'day3 even height-2', :date => "Mi, 28.12.2011"}, 
                     :machine1 => [],
                     :machine2 => ['free'],
                     :machine3 => [],
                     :machine4 => ['free', {:class => 'booking height-2-0 multiday', :id => 'booking_131'}])
        layout_check(table, :row => {:number => 21, :class => 'day4 odd height-2', :date => "Do, 29.12.2011"}, 
                     :machine1 => [],
                     :machine2 => ['free'],
                     :machine3 => [],
                     :machine4 => ['spacer', 'free'])
        layout_check(table, :row => {:number => 22, :class => 'day5 even height-1', :date => "Fr, 30.12.2011"}, 
                     :machine1 => [],
                     :machine2 => ['free'],
                     :machine3 => [],
                     :machine4 => ['free'])
        layout_check(table, :row => {:number => 23, :class => 'day6 odd height-1', :date => "Sa, 31.12.2011"}, 
                     :machine1 => [],
                     :machine2 => ['free'],
                     :machine3 => [],
                     :machine4 => ['free'])
        layout_check(table, :row => {:number => 24, :class => 'day0 even height-3', :date => "So, 01.01.2012"}, 
                     :machine1 => [],
        ...
        layout_check(table, :row => {:number => 25, :class => 'day1 odd height-1', :date => "Mo, 02.01.2012"}, 
                     :machine1 => ['spacer'],
                     :machine2 => [],
                     :machine3 => ['free'],
                     :machine4 => [{:class => 'all_day booking from_midnight height-8-3 multiday', :id => 'booking_129'}])
        layout_check(table, :row => {:number => 26, :class => 'day2 even height-1', :date => "Di, 03.01.2012"}, 
                     :machine1 => ['free'],
                     :machine2 => [],
                     :machine3 => ['free'],
                     :machine4 => [])
        layout_check(table, :row => {:number => 27, :class => 'day3 odd height-1', :date => "Mi, 04.01.2012"}, 
                     :machine1 => ['free'],
                     :machine2 => [],
                     :machine3 => ['free'],
                     :machine4 => [])
        layout_check(table, :row => {:number => 28, :class => 'day4 even height-2', :date => "Do, 05.01.2012"}, 
                     :machine1 => ['free', {:class => 'booking height-2-0 multiday', :id => 'booking_125'}],
                     :machine2 => [],
                     :machine3 => ['free'],
                     :machine4 => [])
        layout_check(table, :row => {:number => 29, :class => 'day5 odd height-3 last', :date => "Fr, 06.01.2012"}, 
